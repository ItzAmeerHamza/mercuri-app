        ...
        <Table sx={{ minWidth: 700 }}>
          ...
          >
            <TableRow>
              ...
              <TableCell>Competency Parameter</TableCell>
              <TableCell>Competency Suggestion</TableCell>
            ...
            {competency?.map((competency) => {
              ...
              return (
                <TableRow hover key={competency.id} selected={isCompetencyelected}>
                  ...
                  <TableCell>
                    {competency.competencyParameter}
                  </TableCell>
                  <TableCell>{competency.competencySuggestion}</TableCell>
                  <TableCell>
                  ...
                  <TableCell align="right">
                    <Link href={{pathname:'/dashboard/competencies/suggestions/edit',query: {...competency} }}>
