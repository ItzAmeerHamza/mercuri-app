...
const EditCompanyGroup = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard: Edit User to Company Team</title>
      </Head>
      <Box
        component="main"
        sx={{
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">Edit User to Company Team</Typography>
              </Grid>
              <Grid item>
              <Link
          ...
          <Container
            ...
            >
              ...
              <Typography
                ...
                variant="body2"
              >
                Edit User to company team on the internal platform
              </Typography>
            </Box>
        <form noValidate >
                ...
                {success &&
                  <Box sx={{ mt: 2 }}>
                    <Alert severity={"info"}>
                      ...
                      <div>
                        <b> Company Team Edited Successfully </b>
                      </div>
...
EditCompanyGroup.getLayout = (page) => (
  <AuthGuard>
