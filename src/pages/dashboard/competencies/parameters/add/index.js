...
const AddCompetencyParameter = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard: Add Competency Parameter</title>
      </Head>
      <Box
        component="main"
        sx={{
      ...
      >
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">Add Competency Parameter</Typography>
              </Grid>
              <Grid item>
              <Link
         href={'/dashboard/competencies/parameters'}
        >
                <Button
                  variant="contained"
                >
        ...
        <TextField
          autoFocus
          error={Boolean(formik.touched.descritpion && formik.errors.descritpion)}
          fullWidth
          helperText={formik.touched.descritpion && formik.errors.descritpion}
          label="Descritpion"
          margin="normal"
          name="descritpion"
          onBlur={formik.handleBlur}
                ...
                {success &&
                  <Box sx={{ mt: 2 }}>
                    <Alert severity={"info"}>
                      ...
                      <div>
                        <b> Competency Parameter Added Successfully </b>
                      </div>
...
AddCompetencyParameter.getLayout = (page) => (
  <AuthGuard>
    <DashboardLayout>{page}</DashboardLayout>
  </AuthGuard>
);

export default AddCompetencyParameter;
